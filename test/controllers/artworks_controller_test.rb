...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { collection_boolean: @artwork.collection_boolean, content_type: @artwork.content_type, description: @artwork.description, name: @artwork.name }
    end
  ...
  test "should update artwork" do
    patch :update, id: @artwork, artwork: { collection_boolean: @artwork.collection_boolean, content_type: @artwork.content_type, description: @artwork.description, name: @artwork.name }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
